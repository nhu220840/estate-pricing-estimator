    ...
    >
      <div>
        ...
        <p className="mt-1 text-sm text-tinix-muted">
          Nhập thông tin tài sản — kết quả qua model / API backend.
        </p>
      </div>
      ...
      <label className="block space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            className={fieldWrap}
            placeholder="Nhập địa chỉ cần định giá"
            value={address}
      ...
      <label className="block space-y-1.5">
        <span className="text-sm font-medium text-tinix-muted">
          Quận / khu vực (tuỳ chọn)
        </span>
        <input
          className="rounded-xl tinix-input px-3 py-3 text-sm w-full"
      ...
      <p className="flex gap-2 text-xs text-tinix-muted leading-relaxed">
        ...
        Kết quả mang tính tham khảo. Giá thực tế có thể thay đổi theo thời điểm
        và đặc điểm riêng của tài sản.
      </p>
    </form>
  );
}
